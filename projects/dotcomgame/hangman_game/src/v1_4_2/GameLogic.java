package projects.dotcomgame.hangman_game.src.v1_4_2;
...
public class GameLogic extends GameState {
    ...
    private boolean isDoubleOrNothing;
    private char lockedLetter;
    ...
    public void setDoubleOrNothing(boolean doubleOrNothing) {
        this.isDoubleOrNothing = doubleOrNothing;
    }

    public void lockRandomLetter() {
        int index = random.nextInt(wordToGuess.length());
        lockedLetter = wordToGuess.charAt(index);
        currentGuess[index] = lockedLetter;
    }
    ...
    public void displayGameState(char[] currentGuess, int remainingGuesses, HashSet<Character> guessedLetters,
                ...
                if (isDoubleOrNothing) {
                    ui.displayDoubleOrNothing();
                }
                if (lockedLetter != '\0') {
                    ui.displayLockedLetter(lockedLetter);
                }
