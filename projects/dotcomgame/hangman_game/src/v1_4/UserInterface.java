package projects.dotcomgame.hangman_game.src.v1_4;
...
import projects.dotcomgame.hangman_game.src.v1_4.GameLogic.Difficulty;
...
public class UserInterface {
    ...
    public boolean askMultiplayerMode() {
        while (true) {
            System.out.println("Do you want to play in multiple player mode");
            String input = sc.nextLine().trim().toLowerCase();
